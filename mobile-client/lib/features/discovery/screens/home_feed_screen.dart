        ...
        child: Column(
          ...
          children: [
                ...
                child: Column(
                  children: [
                    _DrawerItem(
                      ...
                      label: 'Restaurants',
                      // TODO: Pass restaurants filter to Explore when deep-linking is ready
                      onTap: () {
                        Navigator.of(context).pop();
                    ...
                    _DrawerItem(
                      ...
                      // TODO: Pass grocery filter to Explore when deep-linking is ready
                      onTap: () {
                        Navigator.of(context).pop();
                        context.go(AppRoutes.explore);
                      },
                    ...
                    _DrawerItem(
                      ...
                      label: 'Recipes',
                      // TODO: Pass recipes filter to Explore when deep-linking is ready
                      onTap: () {
                        Navigator.of(context).pop();
                        context.go(AppRoutes.explore);
                      },
                    ...
                    _DrawerItem(
                      ...
                      label: 'My List',
                      // TODO: /my-list — saved items, favourites & shopping list
                      onTap: () {
                        Navigator.of(context).pop();
                    ...
                    _DrawerItem(
                      icon: Icons.map_outlined,
                      label: 'Route Map',
                      // TODO: /map — route optimiser across saved locations
                      onTap: () {
                        Navigator.of(context).pop();
                    ...
                    _DrawerItem(
                      ...
                      // TODO: /budget — detailed spending breakdown
                      onTap: () {
                        Navigator.of(context).pop();
            ...
            _DrawerItem(
              ...
              label: 'Settings',
              // TODO: /settings — app preferences, notifications, dietary prefs
              onTap: () {
                Navigator.of(context).pop();
